...
export const action = async ({ request }) => {
  try {
    ...
    // Amount / currency / reference / merchant cross-check against what we
    // persisted (and against the live SumUp merchant, since this callback
    // carries no signature to authenticate it — see checkoutMatchesMerchant).
    if (
